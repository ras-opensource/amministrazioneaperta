...
(9, 'AA_MODULE_SICAR', 'AA_SicarAlloggio', 'mdi mdi-office-building', 'Sistema informativo capacita abitativa Regionale', 'SICAR - Sistema informativo capacita abitativa Regionale', 'sicar', '1', 0, 'Modulo per la gestione della capacità abitativa Regionale', '{\"sicar\":\"SICAR\"}', 0, 0, '');
COMMIT;
