...
--
-- Struttura della tabella `aa_geco_objects`
--

CREATE TABLE `aa_geco_objects` (
...
--
-- Indici per le tabelle `aa_geco_objects`
--
ALTER TABLE `aa_geco_objects`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT per la tabella `aa_geco_objects`
--
ALTER TABLE `aa_geco_objects`
