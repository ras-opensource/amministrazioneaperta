...
Class AA_OrganismiPublicReportTemplateView extends AA_GenericObjectTemplateView
{
    public function __construct($id="AA_OrganismiPublicReportTemplateView",$parent=null,$organismo=null, $user=null)
    {
        ...
        //legenda
        $footer="<div style='font-style: italic; font-size: smaller; text-align: left; width: 100%; margin-bottom: 2em'>Nel presente prospetto sono esposti esclusivamente i dati dei rappresentanti dell'Amministrazione Regionale negli organi di governo e i dati relativi agli incarichi di Amministratore dell'Ente.</span></div>";
