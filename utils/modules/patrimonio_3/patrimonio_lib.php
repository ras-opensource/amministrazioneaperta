...
Class AA_PatrimonioModule extends AA_GenericModule
{
    ...
    public function Template_GetPatrimonioModifyDlg($object=null)
    {
        ...
        //codice comune
        $label="Cod. Comune";
        $catasto->AddTextField("CodiceComune",$label,array("bottomLabel"=>"*Codice Comune.", "required"=>true,"placeholder"=>"Inserisci qui il codice comune...","suggest"=>array("template"=>"#codice#","textValue"=>"#codice#","url"=>$this->taskManagerUrl."?task=GetPatrimonioListaCodiciIstat"))); 
