...
include_once("patrimonio_lib.php");
...
$module= AA_PatrimonioModule::GetInstance($user);
...
if($taskManager->IsManaged($task))
{
  ...
  {
    AA_Log::Log("patrimonio task manager - task: ".$task." - ".$taskManager->GetTaskError($task),100,false,true);
  }
