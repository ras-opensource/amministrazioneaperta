                        ...
                        on: {
                            onAfterSelect: async function(id) {
                                try {
                                    ...
                                    {
                                        //console.log("AA_MainApp.sidebar.onAfterSelect("+id+") - imposto il comune: "+item.comune);
                                        AA_SierWebAppParams.risultati.id_comune=Number(item.comune);
                                    }

                                    if(AA_SierWebAppParams.livello_dettaglio_prev_view_id == AA_SierWebAppParams.risultati.candidati.view_id && AA_SierWebAppParams.risultati.id_comune==0 && AA_SierWebAppParams.risultati.id_circoscrizione==0)
                                    {
            ...
            if($$(AA_SierWebAppParams.affluenza.circoscrizionale.container_id))
            {
                ...
                let affluenza_box={
                    ...
                    [
                        ...
                        {
                            view:"template",
                            template: "<div style='display:flex;align-items:center; justify-content:space-between; height:100%; width:100%; flex-direction: column;'><div style='display:flex; justify-content: space-between; align-items:center; border-bottom:1px solid #b6bcbf;width:100%;'><div style='width:30px;min-width:30px'><a href='#' onClick='AA_SierWebAppParams.affluenza.circoscrizionale.id_circoscrizione=0;$$(AA_SierWebAppParams.affluenza.regionale.view_id).show();' style='font-weight: 700;font-size: 18px;color: #0c467f;' title='Indietro'><span class='mdi mdi-arrow-left'></span></a></div><div style='text-align:center'><span style='font-size:larger; font-weight:bold; color: #0c467f;'>"+AA_SierWebAppParams.data.stats.circoscrizionale[AA_SierWebAppParams.affluenza.circoscrizionale.id_circoscrizione].denominazione+"</span><br><span style='font-size: smaller'>circoscrizione</span></div><div style='width:30px;min-width:30px'>&nbsp;</div></div><div style='display:flex;align-items:center; justify-content:space-between;height:100px; width:100%'><div style='display:flex; flex-direction:column;justify-content:center;align-items:center; font-weight: 600; width:33%; color: #0c467f; border-right: 1px solid #dadee0'><span>ELETTORI</span><hr style='width:96%;color: #eef9ff'><span>#elettori#</span></div><div style='display:flex; flex-direction:column;justify-content:center;align-items:center;font-weight: 600; width:33%; color: #0c467f'><span>VOTANTI</span><hr style='width:100%; color: #eef9ff'><span>#votanti#</span></div><div style='display:flex; flex-direction:column;justify-content:center;align-items:center; width:33%; font-weight:700; font-size: 24px; color: #0c467f'><span>#percent#%</span></div></div></div>",
                            data:{votanti : votanti_tot,percent: votanti_percent,elettori:elettori_tot},
                            height: 140,
                            css: {"border-radius": "15px","border-width":"1px 1px 1px !important"}
                        },
            ...
            if($$(AA_SierWebAppParams.risultati.container_id))
            {
                ...
                let risultati_box={
                    ...
                    [
                        {
                            view:"template",
                            template: "<div style='display:flex;align-items:center; justify-content:space-between; height:100%; width:100%; flex-direction: column;'><div style='display:flex; justify-content: space-between; align-items:center;width:100%;height:100%'><div style='width: 30px'><span>&nbsp;</span></div><div style='text-align:center;'><span>Livello di dettaglio:</span><br><a href='#' onclick='AA_SierWebAppParams.livello_dettaglio_prev_view_id=AA_SierWebAppParams.risultati.view_id;$$(AA_SierWebAppParams.livello_dettaglio_view_id).show();' title='Fai click per cambiare il livello di dettaglio' style='text-decoration: none'><span style='font-weight:bold; color: #0c467f;'>"+AA_SierWebAppParams.risultati.livello_dettaglio_label+"</span></a></div><div style='width:30px;text-align: right'><a href='#' onclick='AA_SierWebAppParams.livello_dettaglio_prev_view_id=AA_SierWebAppParams.risultati.view_id;$$(AA_SierWebAppParams.livello_dettaglio_view_id).show();' title='Fai click per cambiare il livello di dettaglio' style='text-decoration: none; color: #0c467f; font-size: 18px'><span class='mdi mdi-magnify-expand'></span></a></div></div></div>",
            ...
            if($$(AA_SierWebAppParams.risultati.liste.container_id))
            {
                ...
                let risultati_box={
                    ...
                    [
                        {
                            view:"template",
                            template: "<div style='display:flex;align-items:center; justify-content:center; height:100%; width:100%; flex-direction: column;'><div style='display:flex; justify-content: space-between; align-items:center;width:100%;height:100%;'><div style='width:30px;'><a href='#' onClick='AA_SierWebAppParams.risultati.liste.id_coalizione=0;$$(AA_SierWebAppParams.risultati.view_id).show();' style='font-weight: 700;font-size: 18px;color: #0c467f;' title='Indietro'><span class='mdi mdi-arrow-left'></span></a></div><div style='text-align:center;'><span>Livello di dettaglio:</span><br><a href='#' onclick='AA_SierWebAppParams.livello_dettaglio_prev_view_id=AA_SierWebAppParams.risultati.liste.view_id;$$(AA_SierWebAppParams.livello_dettaglio_view_id).show();' title='Fai click per cambiare il livello di dettaglio' style='text-decoration: none'><span style='font-weight:bold; color: #0c467f;'>"+AA_SierWebAppParams.risultati.livello_dettaglio_label+"</span></a></div><div style='display:flex;justify-content:flex-end;align-items:center;width:30px'><span onclick='AA_SierWebAppParams.livello_dettaglio_prev_view_id=AA_SierWebAppParams.risultati.liste.view_id;$$(AA_SierWebAppParams.livello_dettaglio_view_id).show();' title='Fai click per cambiare il livello di dettaglio' style='color: #0c467f; font-size: 18px;cursor:pointer' class='mdi mdi-magnify-expand'></span></div></div></div>",
                            css:{"background-color":"#ebedf0","border-radius": "15px","border-width":"1px 1px 1px !important"},
                            height: 42,
                        },
                        {height:10},
                        {
                            view:"template",
                            template: "<div style='display:flex;align-items:center; justify-content:space-between; height:100%; width:100%; flex-direction: column;'><div style='display:flex; justify-content: center; align-items:center;width:100%'><div style='width:60px;height:60px;display:flex;align-items:center;justify-content:center;border-radius:50%; overflow:hidden'><img src='#image#' style='width:40px'></img></div><div style='text-align:center;'><span style='font-size:larger; font-weight:bold; color: #0c467f;'>"+dettaglio.voti_presidente[AA_SierWebAppParams.risultati.liste.id_coalizione].denominazione+"</span></div><div style='width:45px;display:flex;align-items:center;justify-content:center'>&nbsp;</div></div><div style='display:flex;align-items:center; justify-content:space-between;height:40px; width:100%;border-bottom: 1px solid #dadee0;border-top:1px solid #b6bcbf;background-color:#fbfbfa'><div style='display:flex;justify-content:flex-start;align-items:center; font-weight: 600; width:100%; color: #0c467f;'><span>&nbsp;&nbsp;VOTI PRESIDENTE</span></div><div style='display:flex; flex-direction:column;justify-content:center;align-items:center;font-weight: 600; width: 90px; min-width:90px; color: #0c467f'><span>#voti_presidente#</span></div><div style='display:flex; justify-content:flex-end;align-items:center; width: 90px; min-width: 90px; font-weight:700; font-size: 24px; color: #0c467f'><span>#percent_presidente#%&nbsp;</span></div></div><div style='display:flex; justify-content: space-between; align-items:center; width:100%'><div style='display:flex;align-items:center; justify-content:space-between;height:40px; width:100%;background-color:#fbfbfa;border-bottom: 1px solid #dadee0;'><div style='display:flex; justify-content:flex-start;align-items:center; font-weight: 600; width:100%; color: #0c467f;'><span>&nbsp;&nbsp;VOTI COALIZIONE</span></div><div style='display:flex; justify-content:center;align-items:center;font-weight: 600; width: 90px;min-width:90px; color: #0c467f'><span>#voti_coalizione#</span></div><div style='display:flex; justify-content:flex-end;align-items:center; width:90px;min-width:90px; font-weight:700; font-size: 24px; color: #0c467f'><span>#percent_coalizione#%&nbsp;</span></div></div></div>",
            ...
            if($$(AA_SierWebAppParams.risultati.candidati.container_id))
            {
                ...
                let risultati_box={
                    ...
                    [
                        ...
                        {
                            view:"template",
                            template: "<div style='display:flex;align-items:center; justify-content:space-between; height:100%; width:100%; flex-direction: column;'><div style='display:flex; justify-content: center; align-items:center;width:100%'><div style='width:60px;height:60px;display:flex;align-items:center;justify-content:center;border-radius:50%; overflow:hidden'><img src='#image#' style='width:40px'></img></div><div style='text-align:center;'><span style='font-size:larger; font-weight:bold; color: #0c467f;'>"+dettaglio.voti_lista[AA_SierWebAppParams.risultati.candidati.id_lista].denominazione+"</span></div><div style='width:45px;display:flex;align-items:center;justify-content:center'>&nbsp;</div></div><div style='display:flex;align-items:center; justify-content:space-between;height:40px; width:100%;border-bottom: 1px solid #dadee0;border-top:1px solid #b6bcbf;background-color:#fbfbfa'><div style='display:flex;justify-content:flex-start;align-items:center; font-weight: 600; width:100%; color: #0c467f;'><span>&nbsp;&nbsp;VOTI di LISTA</span></div><div style='display:flex; justify-content:center;align-items:center;font-weight: 600; width:90px;min-width:90px; color: #0c467f'><span>#voti_lista#</span></div><div style='display:flex;justify-content:flex-end;align-items:center; width:90px;min-width:90px; font-weight:700; font-size: 24px; color: #0c467f'><span>#percent_lista#%&nbsp;</span></div></div></div>",
                        ...
                        },
                        {
                            ...
                            borderless: true,
                            css:{"background-color":"transparent"},
                            template:"<div style='font-size:smaller'><i>Fai click sul livello di dettaglio per sceglierne uno diverso.</i></div>",
                            autoheight:true
                        }
                    ]
                };
