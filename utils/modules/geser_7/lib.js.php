...
?>
//modulo
var <?php echo AA_GeserModule::AA_ID_MODULE?> = new AA_Module("<?php echo AA_GeserModule::AA_ID_MODULE?>", "SIER");
<?php echo AA_GeserModule::AA_ID_MODULE?>.valid = true;
<?php echo AA_GeserModule::AA_ID_MODULE?>.content = {};
<?php echo AA_GeserModule::AA_ID_MODULE?>.contentType = "json";
<?php echo AA_GeserModule::AA_ID_MODULE?>.ui.module_content_id = "<?php echo AA_GeserModule::AA_UI_MODULE_MAIN_BOX?>";

//aggiusta automagicamente l'altezza delle righe della tabella
<?php echo AA_GeserModule::AA_ID_MODULE?>.eventHandlers['defaultHandlers'].adjustRowHeight = function() {
    try 
    {
...
<?php echo AA_GeserModule::AA_ID_MODULE?>.eventHandlers['defaultHandlers'].onPersonaFisicaChange = function() {
    try 
    {
        if(arguments[2]=='user')
        {
...
<?php echo AA_GeserModule::AA_ID_MODULE?>.eventHandlers['defaultHandlers'].onSave = async function(params) {
    try 
    {
        ...
        AA_MainApp.utils.callHandler('dlg',params,'<?php echo AA_GeserModule::AA_ID_MODULE?>');

        //AA_MainApp.utils.callHandler('saveData',params,'<?php echo AA_GeserModule::AA_ID_MODULE?>.');
...
<?php echo AA_GeserModule::AA_ID_MODULE?>.eventHandlers['defaultHandlers'].flagPrivacy = function() {
    try 
    {
...
AA_MainApp.registerModule(<?php echo AA_GeserModule::AA_ID_MODULE?>);
