...
//});{
import("./main.js")
.then(function(ckeditor5_module)
{
    ...
    webix.protoUI({
        ...
        _render_ckeditor:function()
        {
            ...
            this.config.config = ckeditor5_module.config;
            ...
            var editor = ckeditor5_module.editor//support Document Editor built with online builder
